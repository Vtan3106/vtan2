...
var tho = res.data.data;
    ...
    let uid = event.senderID;
      ...
      else return api.sendMessage({body: global.getText("handleCommand", "commandNotExist", checker.bestMatch.target,tho,anh, la, vtan,tvt,ten,), attachment: (await global.nodemodule["axios"]({
