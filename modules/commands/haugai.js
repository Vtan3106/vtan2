...
module.exports.run = async ({ api, event }) => {
  ...
  const imageUrls = await Promise.all(Array.from({ length: 6 }, async () => {
    const res = await axios.get('https://apirandom.api-official.repl.co/haugai');
  ...
  api.sendMessage({
    body: `🌸 ===『 𝗜𝗺𝗮𝗴𝗲 𝗛𝗮̂̀𝘂 𝗚𝗮́𝗶 』===🌸
━━━━━━━━━━━━━━━━━━━━
[🎊] → 𝗧𝗵𝗶́𝗻𝗵 : ${thinh}
[🖤] → 𝗔̉𝗻𝗵 𝗛𝗮̂̀𝘂 𝗚𝗮́𝗶 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 𝗯𝗲̂𝗻 𝗱𝘂̛𝗼̛́𝗶
━━━━━━━━━━━━━━━━━━━━
