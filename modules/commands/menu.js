...
module.exports.handleReply = async function ({ api, event, handleReply, Users }) {
	...
	const img = ["https://i.imgur.com/OFjyTkU.jpg",]
...
module.exports.run = async function({ api, event, args, Users }) {
  ...
  let uid = event.senderID;
	...
	var group = [], msg = "=== 𝗗𝗮𝗻𝗵 𝘀𝗮́𝗰𝗵 𝗹𝗲̣̂𝗻𝗵 𝗵𝗶𝗲̣̂𝗻 𝗰𝗼́ ===\n━━━━━━━━━━━━━━━━━━\n";
...
responseType: "stream"
	...
	if (check) {
		...
		msg += `\n━━━━━━━━━━━━━━━━━\n[📖] → 𝗧𝗿𝗮𝗻𝗴 ${page_num_input || 1}/${page_num_total} `;
		msg += `\n[🎀] → Đ𝗲̂̉ 𝘅𝗲𝗺 𝘁𝗼̂̉𝗻𝗴 𝗹𝗲̣̂𝗻𝗵, 𝗱𝘂̀𝗻𝗴: ${prefix}𝗺𝗲𝗻𝘂 𝗮𝗹𝗹`;
    msg += `\n[🧸] → 𝗕𝗮̣𝗻 𝗰𝗼́ 𝘁𝗵𝗲̂̉ 𝗱𝘂̀𝗻𝗴 ${prefix}𝗵𝗲𝗹𝗽 + 𝘁𝗲̂𝗻 𝗹𝗲̣̂𝗻𝗵 đ𝗲̂̉ 𝘅𝗲𝗺 𝗰𝗮́𝗰𝗵 𝗱𝘂̀𝗻𝗴`
		msg += `\n[🍒] → 𝗧𝗼̂̉𝗻𝗴 𝗟𝗲̣̂𝗻𝗵 : ${commands.size}\n[🍍] → 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴 : ${name}\n[🌐] → 𝗟𝗶𝗻𝗸 𝗽𝗿𝗼𝗳𝗶𝗹𝗲 : https://www.facebook.com/profile.php?id=${uid}\n━━━━━━━━━━━━━━━━━\n[💓] → 𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘁𝗵𝗲𝗼 𝘀𝗼̂́ đ𝗲̂̉ 𝘅𝗲𝗺 𝗰𝗮́𝗰 𝗹𝗲̣̂𝗻𝗵 𝘁𝗵𝗲𝗼 𝗽𝗵𝐚̂𝗻 𝗹𝗼𝗮̣𝗶 𝗯𝗼𝘁 đ𝘂̛𝗼̛̣𝗰 đ𝗶𝗲̂̀𝘂 𝗵𝗮̀𝗻𝗵 𝗯𝗼̛̉𝗶 𝐓𝐫𝐚̂̀𝐧 𝐕𝐚̆𝐧 𝐓𝐚̂𝐧\n[🥨] → 𝗙𝗕 𝗔𝗗𝗠𝗜𝗡 : https://www.facebook.com/AnhYeuEm.Tan06`;
  }
	var msgg = {body: msg, attachment: imgP}
	return api.sendMessage({body: msg, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://api.uchihaobito.site/ig')).data.url,
