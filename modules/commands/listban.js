    ...
    case "unbanthread":
      {
        ...
        api.sendMessage({body:`[💝] → 𝐓𝐡𝐨̂𝐧𝐠 𝐛𝐚́𝐨 𝐭𝐮̛̀ 𝐀𝐝𝐦𝐢𝐧 ${name}\n[🥑] → 𝐍𝐡𝐨́𝐦 ${strS}\n[🫐] → 𝐕𝐮̛̀𝐚 𝐡𝐮̛𝐨̛̉𝐧𝐠 𝐚̂𝐧 𝐱𝐚́ 𝐠𝐨̛̃ 𝐛𝐚𝐧 𝐜𝐮̉𝐚 𝐚𝐝𝐦𝐢𝐧\n[🫒] → 𝐂𝐨́ 𝐭𝐡𝐞̂̉ 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐛𝐨𝐭 𝐧𝐠𝐚𝐲 𝐛𝐚̂𝐲 𝐠𝐢𝐨̛̀`,attachment: (await axios.get((await axios.get(`https://api.uchihaobito.site/gai`)).data.url, {
                    responseType: 'stream'
                })).data
}, event.threadID, () =>
    ...
    case 'unbanuser':
      {
        ...
        // api.sendMessage(`${global.data.botID}`, () =>
        api.sendMessage({body:`==== [ 𝐓𝐡𝐮̛̣𝐜 𝐭𝐡𝐢 𝐔𝐧𝐛𝐚𝐧 : 𝐭𝐫𝐮𝐞/𝐟𝐚𝐥𝐬𝐞 ] ====\n━━━━━━━━━━━━━━━━\n[💕] → ${msg}`,attachment: (await axios.get((await axios.get(`https://api.uchihaobito.site/gai`)).data.url, {
                    responseType: 'stream'
                })).data
}, event.threadID, () =>
          api.unsendMessage(handleReply.messageID));
    ...
    case "-t":
      {
        ...
        return api.sendMessage(listbanViews.length != 0 ? api.sendMessage({body:`==== [ 𝗗𝗮𝗻𝗵 𝗦𝗮́𝗰𝗵 𝗡𝗵𝗼́𝗺 𝗕𝗶̣ 𝗕𝗮𝗻 ] ====\n━━━━━━━━━━━━━━━━━━\n[🎀] → 𝐇𝐢𝐞̣̂𝐧 𝐭𝐚̣𝐢 𝐠𝐨̂̀𝐦 𝐜𝐨́ ${listbanViews.length} 𝐧𝐡𝐨́𝐦 𝐛𝐢̣ 𝐛𝐚𝐧\n━━━━━━━━━━━━━━━━━━\n${listbanViews.join("\n━━━━━━━━━━━━━━━━━━\n")}` +
          "\n━━━━━━━━━━━━━━━━━━\n[🥑] → 𝐑𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 + 𝐬𝐨̂́ 𝐭𝐡𝐮̛́ 𝐭𝐮̛̣, 𝐜𝐨́ 𝐭𝐡𝐞̂̉ 𝐫𝐞𝐩 𝐧𝐡𝐢𝐞̂̀𝐮 𝐬𝐨̂́, 𝐜𝐚́𝐜𝐡 𝐧𝐡𝐚𝐮 𝐛𝐚̆̀𝐧𝐠 𝐝𝐚̂́𝐮 𝐜𝐚́𝐜𝐡 𝐧𝐞̂́𝐮 𝐦𝐮𝐨̂́𝐧 𝐮𝐧𝐛𝐚𝐧 𝐭𝐡𝐫𝐞𝐚𝐝 𝐭𝐮̛𝐨̛𝐧𝐠 𝐮̛́𝐧𝐠",attachment: (await global.nodemodule["axios"]({
...
responseType: "stream"
          ...
          messageID
        ) : {body: "[😻] → 𝐇𝐢𝐞̣̂𝐧 𝐭𝐚̣𝐢 𝐤𝐡𝐨̂𝐧𝐠 𝐜𝐨́ 𝐧𝐡𝐨́𝐦 𝐧𝐚̀𝐨 𝐛𝐢̣ 𝐛𝐚𝐧",attachment: (await axios.get((await axios.get(`https://api.uchihaobito.site/ig`)).data.url, {
                    responseType: 'stream'
                })).data
    ...
    case "-u":
      {
        ...
        return api.sendMessage(listbanViews.length != 0 ? api.sendMessage({body:`==== [ 𝐃𝐚𝐧𝐡 𝐒𝐚́𝐜𝐡 𝐔𝐬𝐞𝐫 𝐁𝐢̣ 𝐁𝐚𝐧 ] ====\n━━━━━━━━━━━━━━━━━━\n[🍁] → 𝐇𝐢𝐞̣̂𝐧 𝐭𝐚̣𝐢 𝐠𝐨̂̀𝐦 𝐜𝐨́ ${listbanViews.length} 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴 𝗯𝗶̣ 𝗯𝗮𝗻\n━━━━━━━━━━━━━━━━━━\n${listbanViews.join("\n━━━━━━━━━━━━━━━━━━\n")}` +
          "\n━━━━━━━━━━━━━━━━━━\n[🥑] → 𝐑𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 + 𝐬𝐨̂́ 𝐭𝐡𝐮̛́ 𝐭𝐮̛̣, 𝐜𝐨́ 𝐭𝐡𝐞̂̉ 𝐫𝐞𝐩 𝐧𝐡𝐢𝐞̂̀𝐮 𝐬𝐨̂́, 𝐜𝐚́𝐜𝐡 𝐧𝐡𝐚𝐮 𝐛𝐚̆̀𝐧𝐠 𝐝𝐚̂́𝐮 𝐜𝐚́𝐜𝐡 𝐧𝐞̂́𝐮 𝐦𝐮𝐨̂́𝐧 𝐮𝐧𝐛𝐚𝐧 𝐭𝐡𝐫𝐞𝐚𝐝 𝐭𝐮̛𝐨̛𝐧𝐠 𝐮̛́𝐧𝐠",attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://api.uchihaobito.site/ig')).data.data,
method: "GET",
 responseType: "stream"
          ...
          messageID
        ) : {body: "[😻] → 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗸𝗵𝗼̂𝗻𝗴 𝗰𝗼́ 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴 𝗯𝗶̣ 𝗯𝗮𝗻",attachment: (await axios.get((await axios.get(`https://api.uchihaobito.site/ig`)).data.url, {
                    responseType: 'stream'
                })).data
}, event.threadID, threadID, messageID);
      }
