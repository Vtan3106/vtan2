...
module.exports.config = {
	...
	usages: "check",
  image: 'https://i.imgur.com/Mk0N02h.jpeg',
	cooldowns: 5,
    ddependencies: {
   "request": "",
   "fs-extra":"",
...
⏰======『 06:09:59 』======⏰`, event.threadID, event.messageID);
    var arr = [];
  ...
  return api.sendMessage(
    ...
    event.threadID, event.messageID
      ...
      if (event.senderID != "100079086835283") return api.sendMessage(`→ Đây là lệnh của admin bot`, event.threadID, event.messageID)
            let number = [];
