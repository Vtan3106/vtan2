...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "ad.mp4")) request("https://imgur.com/2LimzXy.mp4").pipe(fs.createWriteStream(dirMaterial + "ad.mp4"));
...
module.exports.handleEvent = async ({ event, api, Currencies,Users, args, utils, global, client }) => {
    ...
    if (event.body.toLowerCase() == "Ad bot là ai thế"){
