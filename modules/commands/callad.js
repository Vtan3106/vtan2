    ...
    switch (handleReply.type) {
      case "reply": {
        ...
        if (s.length == 0) {
          for (let ad of idad) {
            api.sendMessage({
              body: "==== [ 𝗧𝗵𝗼̂𝗻𝗴 𝗕𝗮́𝗼 𝗣𝗵𝗮̉𝗻 𝗛𝗼̂̀𝗶 ] ====\n━━━━━━━━━━━━━━━━\n[📲] → 𝗣𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝘂̛̀ " + name + ":\n[💬] → 𝗡𝗼̣̂𝗶 𝗱𝘂𝗻𝗴: " + (event.body) || "[🧡] → 𝗸𝗵𝗼̂𝗻𝗴 𝗰𝗼́ 𝗻𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝘁𝗿𝗮̉ 𝗹𝗼̛̀𝗶\n[👉] → 𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗽𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝗹𝗮̣𝗶", mentions: [{
                id: event.senderID,
                tag: name
              }]
          ...
          for (let ad of idad) {
            api.sendMessage({
              body: "==== [ 𝗧𝗵𝗼̂𝗻𝗴 𝗕𝗮́𝗼 𝗣𝗵𝗮̉𝗻 𝗛𝗼̂̀𝗶 ] ====\n━━━━━━━━━━━━━━━━\n[📲] → 𝗣𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝘂̛̀ " + name + ":\n" + (event.body) || "[🧡] → 𝗰𝗵𝗶̉ 𝗰𝗼́ 𝘁𝗲̣̂𝗽 𝗸𝗵𝗼̂𝗻𝗴 𝗰𝗼́ 𝗻𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝘁𝗿𝗮̉ 𝗹𝗼̛̀𝗶\n[👉] → 𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗽𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝗹𝗮̣𝗶", attachment: l, mentions: [{
                id: event.senderID,
                tag: name
              }]
            }, ad, (e, data) => global.client.handleReply.push({
...
module.exports.run = async function({ api, event, Threads, args, Users }) {
  try {
    ...
    api.sendMessage(`==== [ 𝗧𝗵𝗼̂𝗻𝗴 𝗕𝗮́𝗼 𝗔𝗱𝗺𝗶𝗻 ] ====\n━━━━━━━━━━━━━━━━\n[👾] → 𝗗𝗮𝗶𝗸𝗮 𝘃𝘂̛̀𝗮 𝗴𝘂̛̉𝗶 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 𝘁𝗼̛́𝗶 ${soad} 𝗔𝗱𝗺𝗶𝗻\n[⏰] → 𝗧𝗵𝗼̛̀𝗶 𝗴𝗶𝗮𝗻: ${gio}`,
      event.threadID,
      () => {
        var idad = global.config.ADMINBOT;
        if (s.length == 0) {
          for (let ad of idad) {
            api.sendMessage({ body: `📱====[ 𝐂𝐀𝐋𝐋 𝐀𝐃𝐌𝐈𝐍 ]====📱\n━━━━━━━━━━━━━━━━\n[👤] → 𝗕𝗮́𝗼 𝗰𝗮́𝗼 𝘁𝘂̛̀: ${name}\n[❗] → 𝗜𝗗 𝗨𝘀𝗲𝗿 ${uid}\n[👨‍👩‍👧‍👧] → 𝗕𝗢𝗫: ${namethread}\n[🔰] → 𝗜𝗗 𝗕𝗢𝗫: ${idbox}\n━━━━━━━━━━━━━━━━\n[💌] → 𝗜𝗻𝗯𝗼𝘅: ${args.join(
              " "
            )}\n[⏰] → 𝗧𝗶𝗺𝗲: ${gio}\n━━━━━━━━━━━━━━━━\n[👉] → 𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗽𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝗹𝗮̣𝗶`, mentions: [{ id: event.senderID, tag: name }] },
              ad, (error, info) =>
          ...
          for (let ad of idad) {
            api.sendMessage({
              body: `📱===[𝐂𝐀𝐋𝐋 𝐀𝐃𝐌𝐈𝐍]===📱\n━━━━━━━━━━━━━━━━\n[👤] → 𝗕𝗮́𝗼 𝗰𝗮́𝗼 𝘁𝘂̛̀: ${name}\n[❗] → 𝗜𝗗 𝗨𝘀𝗲𝗿 ${uid}\n[👨‍👩‍👧‍👧] → 𝗕𝗢𝗫: ${namethread}\n[🔰] → 𝗜𝗗 𝗕𝗢𝗫: ${idbox}\n━━━━━━━━━━━━━━━━\n[💌] → 𝗜𝗻𝗯𝗼𝘅: ${(args.join(
                " "
              )) || "[❤️] → 𝗰𝗵𝗶̉ 𝗰𝗼́ 𝘁𝗲̣̂𝗽 𝗸𝗵𝗼̂𝗻𝗴 𝗰𝗼́ 𝗻𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝗯𝗮́𝗼 𝗰𝗮́𝗼"}\n[⏰] → 𝗧𝗶𝗺𝗲: ${gio}\n[📌] → 𝗞𝗲̀𝗺 𝘁𝗵𝗲𝗼 𝘁𝗲̣̂𝗽\n━━━━━━━━━━━━━━━━\n[👉] → 𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗽𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝗹𝗮̣𝗶`, attachment: l, mentions: [{ id: event.senderID, tag: name }]
            },
              ad, (error, info) =>
              global.client.handleReply.push({
                name: this.config.name,
