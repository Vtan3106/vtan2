...
module.exports.run = async ({ api, event, handleReply, Users, args }) => {
  ...
  if (type == "message_reply") {
    ...
    api.sendMessage({body: `==== [ 𝗧𝗛𝗢̂𝗡𝗚 𝗕𝗔́𝗢 𝗧𝗨̛̀ 𝗔𝗗𝗠𝗜𝗡 ] ====\n━━━━━━━━━━━━━━━━━━\n[👤] → 𝐀𝐝𝐦𝐢𝐧: ${name}\n[🎀] → 𝐓𝐡𝐨̂𝐧𝐠 𝐁𝐚́𝐨 𝐑𝐢𝐞̂𝐧𝐠 𝐓𝐨̛́𝐢 𝐍𝐡𝐨́𝐦 𝐍𝐚̀𝐲\n[💬] → 𝐍𝐨̣̂𝐢 𝐃𝐮𝐧𝐠: ${lydo}\n[⏰️] → 𝐀𝐝𝐦𝐢𝐧 𝐆𝐮̛̉𝐢 𝐕𝐚̀𝐨 𝐋𝐮́𝐜: ${gio}\n━━━━━━━━━━━━━━━\n[👉] → 𝐑𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 đ𝐞̂̉ 𝐩𝐡𝐚̉𝐧 𝐡𝐨̂̀𝐢 𝐥𝐚̣𝐢 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐠𝐮̛̉𝐢`, attachment: fs.createReadStream(path)}, args[0], (e, info) => {
    ...
    api.sendMessage({body: `==== [ 𝗧𝗛𝗢̂𝗡𝗚 𝗕𝗔́𝗢 𝗧𝗨̛̀ 𝗔𝗗𝗠𝗜𝗡 ] ====\n━━━━━━━━━━━━━━━━━━\n[👤] → 𝐀𝐝𝐦𝐢𝐧: ${name}\n[🎀] → 𝐓𝐡𝐨̂𝐧𝐠 𝐁𝐚́𝐨 𝐑𝐢𝐞̂𝐧𝐠 𝐓𝐨̛́𝐢 𝐍𝐡𝐨́𝐦 𝐍𝐚̀𝐲\n[💬] → 𝐍𝐨̣̂𝐢 𝐃𝐮𝐧𝐠: ${lydo}\n[⏰️] → 𝐀𝐝𝐦𝐢𝐧 𝐆𝐮̛̉𝐢 𝐕𝐚̀𝐨 𝐋𝐮́𝐜: ${gio}\n━━━━━━━━━━━━━━━\n[👉] → 𝐑𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 đ𝐞̂̉ 𝐩𝐡𝐚̉𝐧 𝐡𝐨̂̀𝐢 𝐥𝐚̣𝐢 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐠𝐮̛̉𝐢`}, args[0], (e, info) => {
      global.client.handleReply.push({
        type: "callad",
        name: this.config.name,
        author: threadID,
...
module.exports.handleReply = async ({ api, event, handleReply, Users }) => {
  ...
  fs.writeFileSync(path, Buffer.from(getdata, 'utf-8'))
        ...
        api.sendMessage({body:`==== [ 𝗣𝗵𝗮̉𝗻 𝗛𝗼̂̀𝗶 𝗧𝘂̛̀ 𝗨𝘀𝗲𝗿 ] ====\n━━━━━━━━━━━━━━━\n[🏠] → 𝐍𝐨̛𝐢 𝐠𝐮̛̉𝐢: ${threadName}\n[👤] → 𝐏𝐡𝐚̉𝐧 𝐇𝐨̂̀𝐢 𝐓𝐮̛̀: ${name}\n→ [💬] 𝐍𝐨̣̂𝐢 𝐃𝐮𝐧𝐠: ${index.join(" ")}\n[⏰️] → 𝐕𝐚̀𝐨 𝐋𝐮́𝐜: ${gio}\n━━━━━━━━━━━━━━━\n[👉] → 𝐑𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 đ𝐞̂̉ 𝐩𝐡𝐚̉𝐧 𝐡𝐨̂̀𝐢 𝐥𝐚̣𝐢 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐠𝐮̛̉𝐢`}, handleReply.author, (e, info) => {
          global.client.handleReply.push({
                type: "callad",
                name: this.config.name,
                author: threadID,
