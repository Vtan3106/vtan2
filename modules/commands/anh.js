module.exports.config = {
  ...
  module.exports.handleReply = async function ({ event, api , args, handleReply, Users}){
    ...
    for ( const i of choiceList ) {
             if(i == "1"){
         urls.push("https://apirandom.api-official.repl.co/gai");
}
         else if(i == "2"){
         urls.push("https://api.api-official.repl.co/trai");
}
         else if(i == "3"){
         urls.push("https://apirandom.api-official.repl.co/gai");
}
          ...
          urls.push("https://api.api-official.repl.co/meme");
}
         else if(i == "9"){
         urls.push("https://api.api-official.repl.co/mui6");
}
         else if(i == "10"){
         urls.push("https://api.api-official.repl.co/du");
}
         else if(i == "11"){
         urls.push("https://api.api-official.repl.c/mong");
}
        else if(i == "12"){
         urls.push("https://api.api-official.repl.co/nude");
        }
         else if(i == "13"){
